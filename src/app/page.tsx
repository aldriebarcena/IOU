// TO DO: SET UP COPAYER SCREEN
// TO DO:   SIMILAR TO MAIN PAYER SCREEN, BUT TABLE IS READ ONLY
// TO DO:   ON SUBMIT, COPAYER ID IS ADDED TO DATABASE AND ITEMS THEY SELECTED
// TO DO: SET UP SMS
